...
dependencies {
    ...
    implementation("io.dropwizard:dropwizard-auth:4.0.9")
    implementation("io.dropwizard:dropwizard-forms:4.0.9")
    ...
    implementation("org.apache.tika:tika-parser-image-module:3.0.0")
