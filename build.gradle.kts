...
dependencies {
    ...
    implementation("io.swagger.core.v3:swagger-core-jakarta:2.2.14")
    implementation("io.swagger.core.v3:swagger-jaxrs2-jakarta:2.2.13")
    implementation("io.swagger.core.v3:swagger-integration-jakarta:2.2.13")
    ...
    implementation("org.apache.tika:tika-parser-image-module:2.8.0")
