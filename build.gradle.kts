...
dependencies {
    ...
    implementation("io.swagger.core.v3:swagger-core-jakarta:2.2.4")
    implementation("io.swagger.core.v3:swagger-jaxrs2-jakarta:2.2.4")
    implementation("io.swagger.core.v3:swagger-integration-jakarta:2.2.4")
    ...
    implementation("com.twelvemonkeys.imageio:imageio-jpeg:3.9.1")
    implementation("com.twelvemonkeys.imageio:imageio-bmp:3.9.1")
    implementation("com.twelvemonkeys.imageio:imageio-tiff:3.9.1")

    implementation("org.apache.tika:tika-core:2.5.0")
    implementation("org.apache.tika:tika-parser-image-module:2.5.0")
