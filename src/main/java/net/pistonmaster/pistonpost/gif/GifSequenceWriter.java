...
/**
 * Taken from <a href="http://elliot.kroo.net/software/java/GifSequenceWriter/">elliot.kroo.net</a>
 */
public class GifSequenceWriter {
     ...
     */
    public GifSequenceWriter(ImageOutputStream outputStream, int imageType, int timeBetweenFramesMS, boolean loopContinuously, String createBy) throws IOException {
        gifWriter = getWriter();
        ...
        commentsNode.setAttribute("CommentExtension", "Created by " + createBy);
